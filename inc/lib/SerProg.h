...
#define S_CMD_S_LOCKSTATE 0x80 /* Set programmer lock state */
#define S_CMD_S_PROGPARAM 0x81 /* Set Progress Bar params */
#define S_CMD_S_PROGSTATE 0x82 /* Set Progress Bar State */
...
/* serprog */
#define S_PGM_NAME            "serprog-JKBD"   /* The program's name, must < 16 bytes */
